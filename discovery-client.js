...
Fetcher.prototype.queryPath = function queryPath(queryId) {
  ...
  const oFilter = `filter=taxonomy:(label:education,score>0.5),taxonomy.label:!sports,enrichedTitle.taxonomy.label:!sports,${oPubDate},${english}&query=rankings`;
...
Fetcher.prototype.fieldParams = function fieldParams(queryId) {
  ...
  const fields = {
    ...
    obama: fieldGen(`${sevenDaysAgo} - ${today}`, 'Rankings', 'anywhere', 'Any', 'Education', 'Title'),
